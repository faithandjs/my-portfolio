...
export const Home = () => {
    ...
    const [datum, setDatum] = useState({title:'', img:[], text:'', github:'', live:'', target:''})
    const settingDatum = (n) => {
        const {name, img, text, github, live, target} = data.projects[n]
    console.log(data.projects[n] )
        setDatum({ title: name, img, text, github, live, target})
    }
    const carousel = (item, index) => {
        let classes;
        if (index === 0){classes = "carousel-item active"}
        else {classes = "carousel-item"}
        console.log(classes)
            return <div className={classes}>
                        <img src={item[index]} className="d-block w-100" alt="preview of my restaurants website" />
                    </div>
    }
    ...
    return (
        <div className='body'>
            ...
            <section className='about'>
                ...
                As a self-taught developer, I have prioritised connecting with other developers to 
                to check notes with and keep me on the right track and so far, taht has been my most reliable 
                way of learning. Being a programmer means a lot of learning, practicing and building and I am
                 enjoying this journey of self improvement. Thank you for checking out my portfolio, you can check out
                 my projects on <a href='https://github.com/faithandjs' target='_blank'>github</a>.
                </div>
            ...
            <section className='work'>
                ...
                <div className='extras'>
                    <div className='see-more'>
                        <a href="https://github.com/faithandjs?tab=repositories" target='_blank'>More</a>
                    </div>
                    <div className='btn'><a href='okogbo-faith-cv.pdf' download>Download CV</a></div>
                </div> 
            </section>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <div className='footer-btns'>
                               <a href={datum.github} target='_blank'><div><img src={github} /></div></a>
                                <a href={datum.live} target={datum.target}><div><img src={play} /></div></a>
